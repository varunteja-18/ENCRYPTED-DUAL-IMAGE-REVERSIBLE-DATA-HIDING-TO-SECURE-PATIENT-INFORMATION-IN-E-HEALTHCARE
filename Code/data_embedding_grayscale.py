...
def plotGrayScaleEncryptedAndStego():
    ## Initializing Required Variables
    global x,y,new_value,grayscale_stego_image,pixel_list_stego,watermark,watermark_alpha,watermark_alpha_resized,watermarked_grayscale_stego_image,fig,axes,ax1,ax2,ax3,ax4,pixel_list_watermarked,count2,count3,end_time,startdatetime,enddatetime,execution_time
    ...
    cv2.imwrite('watermark_alpha_resized.png', watermark_alpha_resized)
    ...
    watermarked_grayscale_stego_image = cv2.addWeighted(grayscale_stego_image, 1, watermark_alpha_resized, 0.5, 0)
