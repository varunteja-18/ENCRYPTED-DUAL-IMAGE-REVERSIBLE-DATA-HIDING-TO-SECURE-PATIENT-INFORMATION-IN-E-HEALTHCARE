...
## Function to Create GUI for Displaying Secret Message - DICOM
def displayDICOMSecretMessage():
    gui_window = Tk()
    gui_window.title('Patient Details(Displaying Secret Message) - DICOM')
